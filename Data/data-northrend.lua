...
-- -------------------------------------------------------------------------------------------------------------------
-- sunday 20th
   [59606894] = { label = "Scouting the Shore",                 abattle = true, npc = "Galeron", text = "The Alliance begins to scout the path forward, but what rests between their landing and Icecrown?", eventtype = "Battle", attendee = "Any", schedule = "Sunday, Sept 20th", aevent = true, },
...
-- wednesday 23rd
   ...
   [83392647] = { label = "Argent Enlightenment", areport = true, npc = "Thom", text = "Your gathered materials from the enemies of the Light will take shape. Reforge yourself and your armament in the fallen mantle of Light’s Trust.", eventtype = "Forging Quest", attendee = 15, schedule = "Wednesday, Sept 23rd", aevent = true, },
-- thursday 24th
...
-- friday 25th
   [43807770] = { label = "Blood", amagical = true, npc = "Hildira", text = "The Cult of the Damned have returned along with the Scourge, and they wield terrifying magic never before seen on Azeroth. These maddened cultists serve sinister, winged entities that have come from beyond the veil with a fervor not seen since the height of the Lich King’s power. The Ebon Grasp demands that we find their largest outpost and learn where their powers come from... and put an end to as many cultists as possible. With Horde event by Keirras.", eventtype = "Battle, Magic", attendee = 25, schedule = "Friday, Sept 25th", aevent = true, },
   [41807770] = { label = "Blood", hmagical = true, npc = "Keirras", text = "The Cult of the Damned have returned along with the Scourge, and they wield terrifying magic never before seen on Azeroth. These maddened cultists serve sinister, winged entities that have come from beyond the veil with a fervor not seen since the height of the Lich King’s power. The Ebon Grasp demands that we find their largest outpost and learn where their powers come from... and put an end to as many cultists as possible. With Alliance event by Hildira.", eventtype = "Battle, Magic", attendee = 25, schedule = "Friday, Sept 25th", hevent = true, },
...
-- -------------------------------------------------------------------------------------------------------------------
   ...
   [80803050] = { label = "Gathering for Landfall", hmeeting = true, npc = "Horde Leadership", proxy = "This is a proxy for being on ships nearing Dragonblight. There are a couple ships here to use.", text = "The Horde make their advance upon Dragonblight to begin the assault. HORDE, listen and prepare! LOK'TAR OGAR!", eventtype = "Briefing", attendee = "Any", schedule = "Sunday, Sept 20th", hevent = true, },
   [87236000] = { label = "Gathering for Landfall", ameeting = true, npc = "Alliance Leadership", proxy = "This is a proxy for being on ships nearing Dragonblight. There are a few ships here to use.", text = "The Alliance make their advance upon Dragonblight to begin the assault. ALLIANCE, heed the call and learn what comes!", eventtype = "Briefing", attendee = "Any", schedule = "Sunday, Sept 20th", aevent = true, },
   [37018092] = { label = "Gathering for Landfall", meeting = true, npc = "Neutral Leadership", proxy = "This is a proxy for being on ships nearing Dragonblight. There are a couple ships here to use.", text = "The Argents and other neutral allies make their advance upon Dragonblight to begin the assault. ARGENTS AND ALLIES, we stand together to aid all!", eventtype = "Briefing", attendee = "Any", schedule = "Sunday, Sept 20th", nevent = true, },
}; -- Howling Fjord
